...
--  Module : Programmation Orientée Objet - CPI2 ISIMG Gabès
...
-- ============================================================
-- TABLE : utilisateur
-- Représente les 3 types d'utilisateurs : CLIENT, SERVEUSE, CUISINIER
-- ============================================================
...
-- ============================================================
-- TABLE : menu
-- Catégories du menu (ex: Entrées, Plats principaux, Desserts, Boissons)
-- ============================================================
CREATE TABLE menu (
    id          INT AUTO_INCREMENT PRIMARY KEY,
...
-- ============================================================
-- TABLE : commande
-- Commandes passées par les clients (gérées par la serveuse)
-- Statuts : EN_ATTENTE → EN_COURS → PRETE → SERVIE | ANNULEE
-- ============================================================
...
-- Détail des plats dans chaque commande
-- ============================================================
...
-- ============================================================
-- TABLE : facture
-- Facture générée par la serveuse pour une commande SERVIE
-- ============================================================
...
-- ============================================================
-- TABLE : notification
-- Notifications du cuisinier vers la serveuse
-- ============================================================
...
-- Vue : commandes avec détails client et serveuse
...
-- Vue : détail d'une commande avec les plats
